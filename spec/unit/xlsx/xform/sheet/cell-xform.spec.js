...
const expectations = [
  ...
  },
  {
    ...
    xml: '<c r="D5"><f t="dataTable" ref="D5:E6" r1="D4" r2="C5" dt2D="1"></f><v>100</v></c>',
    parsedModel: {
      address: 'D5',
      type: Enums.ValueType.Formula,
      shareType: 'dataTable',
  ...
  {
    title: 'Data Table Formula - 1D (column input)',
    create() {
      return new CellXform();
    },
    preparedModel: {
    ...
    xml: '<c r="E5"><f t="dataTable" ref="E5:E7" r1="D4"></f><v>95</v></c>',
    parsedModel: {
      address: 'E5',
      type: Enums.ValueType.Formula,
      shareType: 'dataTable',
